...
export interface Translations {
  ...
  proUpgrade: {
    ...
    lifetime: string; lifetimeBadge: string;
    periodMonthly: string; periodYearly: string; periodLifetime: string;
    subscribeMonthly: string; subscribeYearly: string; subscribeLifetime: string;
    restore: string; restoreSuccess: string; restoreFailed: string;
    purchaseFailed: string; loadingProducts: string;
    disclaimer: string;
...
const en: Translations = {
  ...
  home: {
    greeting: 'Back for more K-fun? 🎵', goalPrefix: 'Goal:',
    ...
    startNow: '📍 Start Now', startLessonBtn: '▶ 덕질 Mode!',
  ...
  lesson: {
    ...
    tapToSee: '두근두근... flip it! 💓', listen: '🔊 Listen', listenAgain: '🔊 Listen again',
    nextCard: 'Next card! 🎵', startQuiz: 'Quiz time! 🔥',
    chooseAnswer: 'What does it mean? 🎯', correct: '맞아 Legend! 🔥', wrongPrefix: '아이고~ Answer:',
    next: 'Next →', toFillBlank: 'Fill in Blank →', toPronunciation: 'Pronunciation →',
    fillBlankInstruction: 'Fill the blank! 📝',
    tapMic: 'Tap to start · tap again to score 🎤', recording: '🔴 Recording... tap again to score',
    listenFirst: '🔊 Listen first', scoreUnit: 'pts', recognized: 'Recognized:',
    nextWord: 'Next Word →', lessonComplete: 'K-Master! 🏆',
    lessonNotFound: 'Lesson not found.', pronError: 'Error. Please try again.',
    culture: 'Culture', situation: 'Situation', cultureTip: '🎭 K-Culture Tip',
    keyExpressions: 'Key Expressions', dialogue: 'Dialogue', startLesson: "Let's go! 🎤",
  },
  aiChat: {
  ...
  notifContent: {
    dailyTitle: 'Your K-fandom calls! 🎵',
    dailyBody: 'Level up your K-content game — start today\'s lesson!',
  ...
  proUpgrade: {
    ...
    lifetime: 'Lifetime', lifetimeBadge: 'Best Value',
    periodMonthly: '/mo', periodYearly: '/yr', periodLifetime: 'one-time',
...
const ko: Translations = {
  ...
  home: {
    greeting: '오늘도 덕질하러 왔어요? 🎵', goalPrefix: '목표:',
    ...
    startNow: '📍 지금 시작하기', startLessonBtn: '▶ 덕질 시작!',
  ...
  lesson: {
    ...
    tapToSee: '두근두근 탭! 💓', listen: '🔊 듣기', listenAgain: '🔊 다시 듣기',
    nextCard: '다음 카드! 🎵', startQuiz: '퀴즈 타임! 🔥',
    chooseAnswer: '무슨 뜻이게? 🎯', correct: '오 레전드! 🔥', wrongPrefix: '아이고~ 정답:',
    next: '다음 →', toFillBlank: '빈칸 채우기 →', toPronunciation: '발음 연습 →',
    fillBlankInstruction: '빈칸을 채워봐! 📝',
    tapMic: '탭 → 녹음 시작 / 다시 탭 → 채점 🎤', recording: '🔴 녹음 중... (다시 탭하면 채점)',
    listenFirst: '🔊 먼저 듣기', scoreUnit: '점', recognized: '인식된 발음:',
    nextWord: '다음 단어 →', lessonComplete: 'K-마스터! 🏆',
    lessonNotFound: '레슨을 찾을 수 없습니다.', pronError: '오류가 발생했어요. 다시 시도해주세요.',
    culture: '문화 소개', situation: '상황', cultureTip: '🎭 K-문화 포인트',
    keyExpressions: '핵심 표현', dialogue: '대화', startLesson: '덕질 시작! 🎤',
  },
  aiChat: {
  ...
  notifContent: {
    dailyTitle: '오늘도 덕질하러 왔어요? 🎵',
    dailyBody: '진짜 한국어, 오늘도 한 편 더! 덕질하러 GO 🎤',
  ...
  proUpgrade: {
    ...
    lifetime: '평생', lifetimeBadge: '최고 가성비',
    periodMonthly: '/월', periodYearly: '/년', periodLifetime: '1회 결제',
    subscribeMonthly: '월간 구독 시작하기',
    subscribeYearly: '연간 구독 시작하기',
    subscribeLifetime: '평생 이용권 구매',
    restore: '구매 복원',
    restoreSuccess: '구매가 성공적으로 복원되었습니다!',
    restoreFailed: '이전 구매 내역을 찾을 수 없습니다.',
    purchaseFailed: '결제에 실패했습니다. 다시 시도해주세요.',
    loadingProducts: '요금제 불러오는 중...',
...
const es: Translations = {
  ...
  home: {
    greeting: '¿Lista para más K-pop? 🎵', goalPrefix: 'Meta:',
    ...
    startNow: '📍 Comenzar ahora', startLessonBtn: '▶ ¡Modo Fandom!',
  ...
  lesson: {
    ...
    tapToSee: '두근두근... ¡voltea! 💓', listen: '🔊 Escuchar', listenAgain: '🔊 Escuchar de nuevo',
    nextCard: '¡Siguiente card! 🎵', startQuiz: '¡Quiz K-pop! 🔥',
    chooseAnswer: '¿Qué significa? 🎯', correct: '¡Leyenda! 🔥', wrongPrefix: '¡Ay no~ Respuesta:',
    next: 'Siguiente →', toFillBlank: 'Completar →', toPronunciation: 'Pronunciación →',
    fillBlankInstruction: '¡Rellena el espacio! 📝',
    tapMic: 'Toca para grabar · toca de nuevo para calificar 🎤', recording: '🔴 Grabando... toca de nuevo para calificar',
    listenFirst: '🔊 Escuchar primero', scoreUnit: 'pts', recognized: 'Reconocido:',
    nextWord: 'Siguiente palabra →', lessonComplete: '¡K-Master! 🏆',
    lessonNotFound: 'Lección no encontrada.', pronError: 'Error. Por favor intenta de nuevo.',
    culture: 'Cultura', situation: 'Situación', cultureTip: '🎭 Cultura K-real',
    keyExpressions: 'Expresiones Clave', dialogue: 'Diálogo', startLesson: '¡Vamos! 🎤',
  },
  aiChat: {
  ...
  notifContent: {
    dailyTitle: '¡Tu fandom K-pop te llama! 🎵',
    dailyBody: 'Sube de nivel en K-content — ¡empieza la lección de hoy!',
  ...
  proUpgrade: {
    ...
    lifetime: 'De por vida', lifetimeBadge: 'Mejor valor',
    periodMonthly: '/mes', periodYearly: '/año', periodLifetime: 'pago único',
    subscribeMonthly: 'Empezar suscripción mensual',
    subscribeYearly: 'Empezar suscripción anual',
    subscribeLifetime: 'Obtener acceso de por vida',
    restore: 'Restaurar compras',
    restoreSuccess: '¡Compras restauradas con éxito!',
    restoreFailed: 'No se encontraron compras anteriores.',
    purchaseFailed: 'Error al comprar. Por favor, inténtalo de nuevo.',
...
const zh: Translations = {
  ...
  home: {
    greeting: '今天也来追韩流了？🎵', goalPrefix: '目标:',
    ...
    startNow: '📍 立即开始', startLessonBtn: '▶ 追星开始！',
  ...
  lesson: {
    ...
    tapToSee: '扑通扑通... 翻牌！💓', listen: '🔊 听', listenAgain: '🔊 再听一次',
    nextCard: '下一张！🎵', startQuiz: 'K-Pop 测验！🔥',
    chooseAnswer: '猜猜是什么意思？🎯', correct: '传说级答对！🔥', wrongPrefix: '哎呀~ 答案:',
    next: '下一个 →', toFillBlank: '填空练习 →', toPronunciation: '发音练习 →',
    fillBlankInstruction: '填空挑战！📝',
    tapMic: '点击录音 · 再次点击评分 🎤', recording: '🔴 录音中... 再次点击以评分',
    listenFirst: '🔊 先听', scoreUnit: '分', recognized: '识别结果:',
    nextWord: '下一个单词 →', lessonComplete: 'K-达人！🏆',
    lessonNotFound: '找不到课程。', pronError: '发生错误，请重试。',
    culture: '文化介绍', situation: '情境', cultureTip: '🎭 K-文化秘籍',
    keyExpressions: '核心表达', dialogue: '对话', startLesson: '출발！🎤',
  },
  aiChat: {
  ...
  proUpgrade: {
    ...
    lifetime: '终身', lifetimeBadge: '最优价值',
    periodMonthly: '/月', periodYearly: '/年', periodLifetime: '一次性付款',
    subscribeMonthly: '开始月度订阅',
    subscribeYearly: '开始年度订阅',
    subscribeLifetime: '获取终身使用权',
    restore: '恢复购买',
    restoreSuccess: '购买恢复成功！',
    restoreFailed: '未找到之前的购买记录。',
    purchaseFailed: '购买失败，请重试。',
    loadingProducts: '加载方案中...',
...
const ja: Translations = {
  ...
  home: {
    greeting: '今日も推し活しに来た？🎵', goalPrefix: '目標:',
    ...
    startNow: '📍 今すぐ始める', startLessonBtn: '▶ 推し活開始！',
  ...
  lesson: {
    ...
    tapToSee: 'ドキドキ... めくってみて！💓', listen: '🔊 聞く', listenAgain: '🔊 もう一度聞く',
    nextCard: '次のカードへ！🎵', startQuiz: 'K-POPクイズ！🔥',
    chooseAnswer: 'どういう意味？🎯', correct: 'レジェンド正解！🔥', wrongPrefix: 'あいや~ 正解:',
    next: '次へ →', toFillBlank: '穴埋め →', toPronunciation: '発音練習 →',
    fillBlankInstruction: '穴埋めチャレンジ！📝',
    tapMic: 'タップで録音 · もう一度タップで採点 🎤', recording: '🔴 録音中... もう一度タップで採点',
    listenFirst: '🔊 まず聞く', scoreUnit: '点', recognized: '認識結果:',
    nextWord: '次の単語 →', lessonComplete: 'Kマスター！🏆',
    lessonNotFound: 'レッスンが見つかりません。', pronError: 'エラーが発生しました。再試行してください。',
    culture: '文化紹介', situation: '状況', cultureTip: '🎭 リアルK-文化',
    keyExpressions: 'キーフレーズ', dialogue: '会話', startLesson: '推し活スタート！🎤',
  },
  aiChat: {
  ...
  notifContent: {
    dailyTitle: '今日も推し活しましたか？🎵',
    dailyBody: 'K-コンテンツレベルアップ — 今日のレッスンを始めましょう！',
  ...
  proUpgrade: {
    ...
    lifetime: '永久', lifetimeBadge: '最高コスパ',
    periodMonthly: '/月', periodYearly: '/年', periodLifetime: '買い切り',
    subscribeMonthly: '月次サブスクリプション開始',
    subscribeYearly: '年次サブスクリプション開始',
    subscribeLifetime: '永久アクセスを取得',
    restore: '購入を復元',
    restoreSuccess: '購入が正常に復元されました！',
    restoreFailed: '以前の購入履歴が見つかりませんでした。',
    purchaseFailed: '購入に失敗しました。もう一度お試しください。',
    loadingProducts: 'プランを読み込み中...',
...
const vi: Translations = {
  ...
  home: {
    greeting: 'Hôm nay cũng đến học K-fun? 🎵', goalPrefix: 'Mục tiêu:',
    ...
    startNow: '📍 Bắt đầu ngay', startLessonBtn: '▶ Fandom Mode!',
  ...
  lesson: {
    ...
    tapToSee: 'Hồi hộp... lật thẻ thôi! 💓', listen: '🔊 Nghe', listenAgain: '🔊 Nghe lại',
    nextCard: 'Tiếp card! 🎵', startQuiz: 'Quiz K-pop! 🔥',
    chooseAnswer: 'Nghĩa là gì nhỉ? 🎯', correct: 'Huyền thoại! 🔥', wrongPrefix: 'Ôi trời~ Đáp án:',
    next: 'Tiếp theo →', toFillBlank: 'Điền chỗ trống →', toPronunciation: 'Luyện phát âm →',
    fillBlankInstruction: 'Điền vào chỗ trống! 📝',
    tapMic: 'Nhấn để ghi · nhấn lại để chấm điểm 🎤', recording: '🔴 Đang ghi... nhấn lại để chấm điểm',
    listenFirst: '🔊 Nghe trước', scoreUnit: 'điểm', recognized: 'Nhận diện:',
    nextWord: 'Từ tiếp theo →', lessonComplete: 'K-Master! 🏆',
    lessonNotFound: 'Không tìm thấy bài học.', pronError: 'Lỗi xảy ra. Vui lòng thử lại.',
    culture: 'Văn Hóa', situation: 'Tình Huống', cultureTip: '🎭 Bí Kíp K-thực',
    keyExpressions: 'Cụm Từ Chính', dialogue: 'Hội Thoại', startLesson: 'Fandom Go! 🎤',
  },
  aiChat: {
  ...
  notifContent: {
    dailyTitle: 'Hôm nay cũng đến học K-fun chưa? 🎵',
    dailyBody: 'Nâng cấp K-content của bạn — bắt đầu bài học hôm nay nhé!',
  ...
  proUpgrade: {
    ...
    lifetime: 'Trọn đời', lifetimeBadge: 'Tốt nhất',
    periodMonthly: '/tháng', periodYearly: '/năm', periodLifetime: 'một lần',
    subscribeMonthly: 'Bắt đầu đăng ký hàng tháng',
    subscribeYearly: 'Bắt đầu đăng ký hàng năm',
    subscribeLifetime: 'Mua truy cập trọn đời',
    restore: 'Khôi phục mua hàng',
    restoreSuccess: 'Khôi phục mua hàng thành công!',
    restoreFailed: 'Không tìm thấy giao dịch mua trước đó.',
    purchaseFailed: 'Mua hàng thất bại. Vui lòng thử lại.',
    loadingProducts: 'Đang tải gói...',
